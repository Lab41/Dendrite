        ...
        return {
            ...
            metrics: function(projectId) {
              var x =
              {
                    ...
                    communities: {
                        metrics: {
                            "Density": {avg: 0.124139887683},
                            "Avg Degree": {avg: 6.56826995761},
                            "FOMD": {avg: 0.00233333333333},
                            "TPR": {avg: "Not Implemented"},
                            "Avg Boundary Edges": {avg: 3.69049518469},
                            "Cut Ratio": {avg: 0.0136242703939},
                            "Conductance": {avg: 0.049332930715},
                            "Normalized Cut": {avg: 0.101576987981},
                            "Separability": {avg: 0.815689805154},
                            "Cohesiveness": {avg: "Not Implemented"}
                        },
                        details: [
                          { id: 0,
                            vertices: parseInt(Math.random() * (5000-100) + 100),
                            edges: parseInt(Math.random() * (50000-1000) + 100),
                            metrics: {
                              "Density": 0.105911330049,
                              "Avg Degree": 6.65517241379,
                              "FOMD": 0.0,
                              "TPR": "Not Implemented",
                              "Expansion": 3.68965517241,
                              "Out Degree Fraction": {
                                        'max': 0.75,
                                        'average': 0.512421008110663,
                                        'flake': 0.5517241379310345
                              },
                              "Cut Ratio": 0.0136149637358,
                              "Conductance": 0.0507831039393,
                              "Normalized Cut": 0.103727191025,
                              "Separability": 0.803738317757,
                          ...
                          { id: 1,
                            ...
                            edges: parseInt(Math.random() * (50000-1000) + 100),
                            metrics: {
                              "Density": 0.0931174089069,
                              "Avg Degree": 6.87179487179,
                              "FOMD": 0.00333333333333,
                              "TPR": "Not Implemented",
                              "Expansion": 3.33333333333,
                              "Out Degree Fraction": {
                                        'max': 0.75,
                                        'average': 0.44584304584304574,
                                        'flake': 0.3333333333333333
                              },
                              "Cut Ratio": 0.0127713920817,
                              "Conductance": 0.0610328638498,
                              "Normalized Cut": 0.126293908026,
                              "Separability": 1.06153846154,
                              "Cohesiveness": "Not Implemented"
                            }
                          },
                          { id: 2,
